  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        {/* soft glow blobs */}
        <div className="absolute -left-32 top-[-10%] h-72 w-72 rounded-full bg-primary/20 blur-3xl opacity-70 animate-float" style={{ animationDelay: "0s" }} />
        <div className="absolute right-[-10%] top-1/3 h-80 w-80 rounded-full bg-[rgba(56,189,248,0.2)] blur-3xl opacity-80 animate-float" style={{ animationDelay: "2s" }} />
        <div className="absolute bottom-[-20%] left-1/2 h-64 w-64 -translate-x-1/2 rounded-full bg-[rgba(94,234,212,0.2)] blur-3xl opacity-80 animate-float" style={{ animationDelay: "4s" }} />

        {/* subtle grid */}
        <div className="absolute inset-0 opacity-[0.08] mix-blend-multiply dark:mix-blend-soft-light [background-image:linear-gradient(to_right,rgba(148,163,184,0.35)_1px,transparent_1px),linear-gradient(to_bottom,rgba(148,163,184,0.35)_1px,transparent_1px)] [background-size:40px_40px]" />
      ...
      <div className="relative z-10 mx-auto flex max-w-6xl flex-col items-center px-4 text-center w-full py-12">
        ...
        <div
          ref={badgeRef}
          className="mb-4 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-background/60 px-4 py-1 text-xs font-medium uppercase tracking-[0.18em] backdrop-blur-xl"
          style={{
            boxShadow:
              "0 0 0 1px rgba(255,255,255,0.05), 0 22px 45px rgba(15,23,42,0.65)",
          }}
        >
          <span className="h-1 w-1 rounded-full bg-primary shadow-[0_0_12px_rgba(129,140,248,0.9)]" />
        ...
        >
          ...
          <div className="pointer-events-none absolute inset-[-40px] -z-10 rounded-[40px] bg-[conic-gradient(from_140deg,rgba(94,234,212,0.0),rgba(94,234,212,0.5),rgba(129,140,248,0.4),rgba(236,72,153,0.5),rgba(94,234,212,0.0))] opacity-70 blur-2xl" />
          ...
          <h1
            ...
            style={{
              ...
              filter: isHovering
                ? "drop-shadow(0 30px 60px rgba(88,28,135,0.55))"
                : "drop-shadow(0 18px 40px rgba(15,23,42,0.75))",
              backgroundImage:
                "linear-gradient(120deg, var(--foreground), rgba(129,140,248,0.95), rgba(45,212,191,0.95))",
        ...
        >
          {/* Search Bar card */}
          <div
            className="relative rounded-2xl border border-border/60 bg-background/70 p-3 shadow-[0_18px_80px_rgba(15,23,42,0.7)] backdrop-blur-2xl overflow-visible z-[10000]"
          >
            ...
            <div className="mt-2 flex items-center justify-between text-[11px] text-muted-foreground">
              <span className="flex items-center gap-1.5">
                <span className="inline-flex h-4 w-4 items-center justify-center rounded border border-border/70 text-[9px]">
                  ⌘K
                </span>
                Open global search
              </span>
              <span className="hidden items-center gap-1 sm:inline-flex">
                ...
                <span>Live index · &lt; 200ms answers</span>
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <a
              href="/dashboard"
              className="relative w-full rounded-xl border border-border/60 bg-background/70 px-8 py-3 text-center text-sm font-semibold text-foreground shadow-[0_18px_40px_rgba(15,23,42,0.85)] backdrop-blur-xl transition-transform duration-200 hover:-translate-y-0.5 hover:border-primary/50 hover:shadow-[0_24px_70px_rgba(15,23,42,0.95)] sm:w-auto"
            >
              <span className="relative flex items-center justify-center gap-2">
                <span className="text-lg">📚</span>
